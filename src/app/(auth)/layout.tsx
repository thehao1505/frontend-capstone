...
const AuthLayout = ({ children }: AuthLayoutProps) => {
  return (
    // <div className='bg-[#000] bg-top bg-cover h-full flex flex-col'>
    //   <div className='z-[4] h-full w-full flex flex-col items-center justify-center'>
    <div className='bg-neutral-950 bg-top bg-cover h-screen flex flex-col justify-between'>
      <div className='flex-grow flex items-center justify-center z-[4]'>
